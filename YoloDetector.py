...
class YoloDetector(object):
    def __init__(self):
        ...
        self.webcam = self.source.isnumeric() or self.source.startswith(
            ('rtsp://', 'rtmp://', 'http://')) or self.source.endswith('.txt')
...
def detect(save_img=False):
    ...
    out = 'DOTA_demo_view/eva_detection'
    # TODO
    source = 'DOTA_demo_view/images/P0007__1__0___0.png'
    weights = './weights/YOLOv5_DOTAv1.5_OBB.pt'
    view_img = False
    save_txt = False
    imgsz = 1024
